...
# Initialize session state for tracking processed columns
...
if uploaded_file is not None:
    ...
    if st.session_state.step >= 0:  # Show step 1 if step is 0 or higher
    ...
    if st.session_state.step == 3:  # Summary Step
        ...
        st.write("### Final DataFrame after Handling Missing Values:")
        st.write(df)
